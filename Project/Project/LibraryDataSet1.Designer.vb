...
Partial Public Class LibraryDataSet1
    ...
    Partial Public Class tblUserDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddtblUserRow(ByVal Name As String, ByVal PhoneNum As String, ByVal Username As String, ByVal Password As String, ByVal Address As String) As tblUserRow
            Dim rowtblUserRow As tblUserRow = CType(Me.NewRow,tblUserRow)
            Dim columnValuesArray() As Object = New Object() {Name, PhoneNum, Username, Password, Address}
    ...
    Partial Public Class tblUserRow
        ...
        Public Property PhoneNum() As String
            Get
                Return CType(Me(Me.tabletblUser.PhoneNumColumn),String)
            End Get
            Set
                Me(Me.tabletblUser.PhoneNumColumn) = value
            End Set
        End Property
...
Namespace LibraryDataSet1TableAdapters
    ...
    Partial Public Class tblUserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblUser] WHERE (([Name] = @Original_Name) AND ([PhoneNum] = @O"& _ 
                "riginal_PhoneNum) AND ([Username] = @Original_Username) AND ([Password] = @Origi"& _ 
                "nal_Password))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUser] ([Name], [PhoneNum], [Username], [Password], [Address"& _ 
                "]) VALUES (@Name, @PhoneNum, @Username, @Password, @Address);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Name, Phon"& _ 
                "eNum, Username, Password, Address FROM tblUser WHERE (Username = @Username)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblUser] SET [Name] = @Name, [PhoneNum] = @PhoneNum, [Username] = @"& _ 
                "Username, [Password] = @Password, [Address] = @Address WHERE (([Name] = @Origina"& _ 
                "l_Name) AND ([PhoneNum] = @Original_PhoneNum) AND ([Username] = @Original_Userna"& _ 
                "me) AND ([Password] = @Original_Password));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Name, PhoneNum, Username, Pa"& _ 
                "ssword, Address FROM tblUser WHERE (Username = @Username)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Name, PhoneNum, Username, Password, Address FROM dbo.tblUser"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As LibraryDataSet1.tblUserDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As LibraryDataSet1.tblUserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As LibraryDataSet1.tblUserDataTable = New LibraryDataSet1.tblUserDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As LibraryDataSet1.tblUserDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Name As String, ByVal Original_PhoneNum As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal PhoneNum As String, ByVal Username As String, ByVal Password As String, ByVal Address As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal PhoneNum As String, ByVal Username As String, ByVal Password As String, ByVal Address As String, ByVal Original_Name As String, ByVal Original_PhoneNum As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            If (Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Name")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal PhoneNum As String, ByVal Password As String, ByVal Address As String, ByVal Original_Name As String, ByVal Original_PhoneNum As String, ByVal Original_Username As String, ByVal Original_Password As String) As Integer
            Return Me.Update(Name, PhoneNum, Original_Username, Password, Address, Original_Name, Original_PhoneNum, Original_Username, Original_Password)
        End Function
    End Class
